                        ...
                        <form action="{{ route('admin.books.update', $book->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    <label for="cover"><b>Kapak</b> <i>JPG olmalı.</i><a
                                            href="{{ asset('storage/'.$book->slug)  }}.jpg"
                                            target="_blank"> {{$book->slug}}.jpg</a>
                                    </label>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" placeholder="Kitap Adı"
                                           ...
                                           name="title" value="{{ $book->title }}" autocomplete="off"
                                           required>
                                    @if ($errors->has('title'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('title') }}
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" placeholder="Tip"
                                           ...
                                           name="type" value="{{ $book->type  }}" autocomplete="off"
                                           required>
                                    @if ($errors->has('type'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('type') }}
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" placeholder="ISBN"
                                           ...
                                           name="isbn" value="{{ $book->isbn }}" autocomplete="off">
                                    @if ($errors->has('isbn'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('isbn') }}
                                        </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="location_id" name="location_id"
                                        ...
                                        @foreach($cities as $city)
                                            <option
                                                value="{{ $city->id }}" {{ $city->id == $book->bookDetails->location_id ? 'selected' : '' }}>
                                                {{ $city->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" id="startDate" name="publication_year"
                                           ...
                                           value="{{ $book->birthdate ? date('Y-m-d', strtotime($book->birthdate)) :  date("Y-m-d") }}">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="edition" name="edition"
                                        ...
                                        @for ($i = 1; $i<=15; $i++)
                                            <option value="{{ $i }}" {{ $i == $book->edition ? 'selected' : '' }}>{{ $i
                                                }}. Baskı
                                            </option>
                                        @endfor
                                    </select>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select id="sellector" name="authors[]" multiple
                                        ...
                                        @foreach($authors as $author)
                                            <option
                                                value="{{ $author->id }}" {{ in_array( $author->id, $book->authors) ? 'selected' : '' }}>
                                                {{ $author->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select id="publisher" name="publisher"
                                        ...
                                        @foreach($publishers as $publisher)
                                            <option
                                                value="{{ $publisher->id }}" {{ $publisher->id == $book->publisher_id ? 'selected' : '' }}>
                                                {{ $publisher->name }}
                                            </option>
                                        @endforeach
                                    </select>
