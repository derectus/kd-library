...
class RequestInformation extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Kolleksiyon Onayı - Klavye Delikanlıları Kütüphanesi')
            ->greeting('Merhaba ' . $this->user->name . '!')
            ->line('Bu e-postayı  koleksiyonuna başvurduğunuz için alıyorsunuz.')
            ->line('Başvrunuz onaylanmıştır. Gönderim işlemeri en kısa sürede tarafınızla iletişime geçerek başlayacaktır.')
